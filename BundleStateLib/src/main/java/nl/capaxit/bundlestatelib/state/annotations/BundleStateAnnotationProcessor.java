...
public final class BundleStateAnnotationProcessor {
    ...
    public static void storeState(final Object target, final Bundle savedInstanceState) {
        try {
    ...
    public static void restoreState(final Object target, final Bundle outState) {
        try {
            final Field[] fields = target.getClass().getDeclaredFields();
            for (final Field field : fields) {
                if (field.isAnnotationPresent(BundleState.class)) {
